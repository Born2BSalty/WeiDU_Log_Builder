...
from wlb.ui.step2.readme_scan_worker import ReadmeScanWorker
...
class ReadmeLookup:
    ...
    def _start(self, tp2_path: Path, mod_name: str, game_dir: Path) -> None:
        ...
        self._worker = ReadmeScanWorker(self._scan_service, tp2_path, mod_name, game_dir)
        self._worker.moveToThread(self._thread)
        self._thread.started.connect(self._worker.run)
        self._worker.finished.connect(self._on_found)
