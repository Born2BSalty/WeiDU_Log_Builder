...
def build_setup_sections() -> SetupSections:
    ...
    options_box, logs_checkbox, install_log_checkbox, debug_checkbox, trace_checkbox = (
        build_options_section()
    )
    component_logs_box, component_logs_picker, component_logs_note = build_component_logs_section()
    ...
    return SetupSections(
        ...
        component_logs_picker=component_logs_picker,
        ...
        per_component_checkbox=per_component_checkbox,
